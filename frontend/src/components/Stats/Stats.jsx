...
export default function Stats({ response }) {
	...
	return (
		<div className='font-bold p-4  bg-black rounded-lg '>
			...
			<div className='text-white p-4 pt-0 flex justify-center text-xl max-[768px]:text-lg '>
				Stats
			</div>
			<div className='text-green-600 flex justify-between max-[768px]:text-lg'>
				Easy
				<div>
			...
			<ProgressBar
				progress={problemsSolved.easy / TotalProblems.easy}
				color='green'
			/>
			<div className='text-yellow-500 flex justify-between max-[768px]:text-lg'>
				Medium
				<div>
			...
			<div className='text-red-600 flex justify-between max-[768px]:text-lg'>
				Hard
				<div>
			...
			<ProgressBar
				progress={problemsSolved.hard / TotalProblems.hard}
				color='red'
			/>
		</div>
	);
