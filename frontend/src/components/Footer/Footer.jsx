...
const Footer = () => {
	return (
		<div className=' w-full h-full flex items-center justify-between px-4 border-t-2 border-[#fff]/[.2] py-2 flex-col lg:flex-row'>
			...
			<div className='text-white  flex gap-2 text-lg justify-center items-center text-[0.75em]  w-full lg:mx-auto lg:text-nowrap lg:text-xl'>
