        ...
        useEffect(() => {
                ...
                socket &&
                        socket.on("codeUpdate", ({ code }) => {
                                console.log(code);
                                newCode = code;
                                updateBody({ ...body, code: code, language: newLanguage, userInput: newInput });
                        });
                ...
                socket &&
                        socket.on("inputUpdate", ({ userInput }) => {
                                ...
                                newInput = userInput;
                                updateBody({ ...body, userInput: userInput, language: newLanguage, code: newCode });
                        });
                socket &&
                        socket.on("languageChange", ({ language }) => {
                                console.log(language);
                                newLanguage = language;
                                updateBody({ ...body, language: newLanguage, userInput: newInput, code: newCode });
                        });
                        ...
                        <div className="flex">
                                ...
                                <div>
                                        <div className="flex w-[50vw] gap-5">
                                                <div className="w-[48%] mt-[4vh] h-[88vh] flex flex-col gap-10">
                                                        <div className="h-[40%]">
                                                ...
                                                <div className="flex justify-evenly items-center h-[88vh] flex-col w-[48%]">
                                                        <CopyToClipboard
                                                                text={roomID}
                                                                onCopy={() =>
                                                                        toast.success(
                                                        ...
                                                        >
                                                                <div className="ml-[2vw] mt-[2vh] w-[50%] h-[6vh] bg-[#2f3136] rounded-lg flex justify-between p-3 cursor-pointer hover:bg-[#9298a8]">
                                                        ...
                                                        <div className="w-[90%] ml-[2vw] mt-[2vh] h-[90%] flex flex-col gap-10">
                                                        ...
                                                        <div className="w-[90%] ml-[2vw] mt-[2vh] h-[10%] flex flex-col gap-10">
