...
function LeaderBoard() {
        ...
        return (
                <>
                        <Header />
                        <div className="h-[87.5vh] flex justify-center items-center max-h-[88vh]">
                                {data ? (
                                        <div className="max-h-[80%]">
                                                <table className=" text-xl text-white border-4 rounded-md border-separate border-red-400 shadow-2xl bg-[#32085e] border-spacing-8 ">
